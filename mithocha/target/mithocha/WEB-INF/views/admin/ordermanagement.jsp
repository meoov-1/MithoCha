...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; font-family:'Inter',sans-serif; }
        ...
        .orders-container {
            display: grid;
            grid-template-columns: 2.3fr 1fr; /* give more space to left */
            gap: 32px; /* more breathing room */
            padding: 32px 48px; /* increase outer spacing */
            max-width: 1400px;
    ...
    <main class="main-content">
        ...
        <div class="orders-container">
            ...
            <div class="orders-left">
                ...
                <div class="orders-header">
                    <div>
                        ...
                        <p>Manage your premium bubble tea requests with precision.</p>
                    </div>
                    <button class="export-btn">
                        <i class="ph ph-download-simple"></i> Export Daily Report
                    </button>
                </div>

                <!-- FILTERS -->
                <div class="order-filters">
                    <button class="filter active">All Orders</button>
                    <button class="filter">Preparing (4)</button>
                    <button class="filter">Out for Delivery (2)</button>
                    <button class="filter">Delivered (12)</button>
                </div>
                ...
                <div class="order-card preparing">
                    <div class="order-top">
                        <div>
                            <h3>#ORD-4921 <span class="badge">PREPARING</span></h3>
                            <p>Aarya Sharma • 2 items</p>
                        </div>
                ...
                <div class="order-card delivery">
                    <div class="order-top">
                        <div>
                            <h3>#ORD-4918 <span class="badge blue">OUT FOR DELIVERY</span></h3>
                            <p>Rohan Karki • 1 item</p>
                        </div>
                        <div class="price">Rs. 680</div>
                    </div>
                    <p class="delivery-info">Arriving in ~10 mins</p>
                </div>

                <div class="order-card delivered">
                    <div class="order-top">
                        <div>
                            <h3>#ORD-4902 <span class="badge gray">DELIVERED</span></h3>
                            <p>Sneha Tamang • 3 items</p>
                        </div>
            ...
            <div class="order-detail">
                ...
                <div class="items">
                    <h4>Royal Assam Milk Tea</h4>
                    <p>Sugar: 50% | Ice: Less Ice</p>

                    <h4>Matcha Cloud Latte</h4>
                    <p>Size: Large | Sugar: 100%</p>
                </div>
                ...
                <div class="actions">
                    <button class="btn-outline">Print Receipt</button>
                    <button class="btn-primary">Ready for Pickup</button>
                </div>
