...
<main class="page-shell login-layout">
    <section class="hero-panel">
        ...
        <div class="hero-content">
            ...
            <div>
                ...
                <p class="hero-text">Sign in to continue browsing the MithoCha customer experience.</p>
            </div>
        </div>
    </section>
    ...
    <section class="form-panel">
        <div class="form-wrap">
            ...
            <p class="section-copy">Use the tabs below to switch between login and register pages.</p>
            ...
            <div class="form-divider">
                <p>Need an account? <a class="inline-link" href="${pageContext.request.contextPath}/register">Register Now</a></p>
            </div>
