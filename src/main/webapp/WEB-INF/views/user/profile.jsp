    ...
    <div class="content-wrap">
        ...
        <section class="profile-layout">
            <aside class="page-card profile-photo-card">
                ...
                <p class="field-help" id="imageSelectionStatus">Current photo stays saved until you choose a new one and save the form.</p>
            ...
            <section class="page-card profile-form-card">
                ...
                <form class="profile-form" action="${pageContext.request.contextPath}/profile" method="post" enctype="multipart/form-data">
                    <%-- Hidden file input — triggered by "Choose Photo" button on the left card --%>
                    <input type="file" id="profileImageFile" name="profileImage"
